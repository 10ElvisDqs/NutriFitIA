<div class="d-flex justify-content-around align-items-center bg-light p-3 rounded shadow-sm">
    ...
    <div class="text-center">
      ...
      <div class="text-danger fw-bold">1500kcal</div>
    ...
    <div class="text-center">
      ...
      <div class="text-success fw-bold">196g</div>
